...
public class  ApplicationState implements IApplicationState{
    ...
    public ShapeConfiguration getCurrentShapeConfiguration() {
        return new ShapeConfiguration(this.getActiveShapeType(),
                this.getActivePrimaryColor(), this.getActiveSecondaryColor(),this.getActiveShapeShadingType(),
                this.getActiveMouseMode());
    }
}
